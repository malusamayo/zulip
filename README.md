...
* 5p: If you use any forms of AI coding assistance, an AI usage history should be provided. This should include (a) history that is automatically logged using the provided extension, and (b) any AI conversations that happen outside of the development environment. This is purely for research purposes and will not affect your grades as long as you share the history.
